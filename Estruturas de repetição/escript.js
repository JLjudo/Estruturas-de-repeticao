...
const empresas = ["CocaCola", "Nike", "Adidas", "Lacoste"];
...
let celu = ["LG", "Samsung", "Motorola", "Iphone", "Xiamo"];
let c = 0;
...
const infoPessoa = [  // Sintaxe de como criar um Array de Objetos em JS 
		   {nome: "João", idade: 18, altura:1.8},
		   {nome: "Wilson", idade: 28, altura:1.6},
		   {nome: "Lucas", idade: 19, altura:1.5},
		   {nome: "Carlos", idade: 25, altura:1.9},
		   {nome: "José", idade: 32, altura:1.4},
        ];
